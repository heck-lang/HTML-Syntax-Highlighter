hljs.registerLanguage("heck", function() {
    ...
    let HECK_KEYWORDS = {
        keyword: 'if else while for return class namespace func extern let int string bool float char import export const static friend public private operator global this new unique shared',
        literal: 'true false',
        built_in: 'print'
    };
